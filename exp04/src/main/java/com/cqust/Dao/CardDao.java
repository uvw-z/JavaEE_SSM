...
public class CardDao {
    ...
    public int insert(Card card){
        ...
        return num;
        //novel
       /* String strSQL="insert into card(sid,sno,name,cno,money,lastAccessTime)VALUE(%d,'%s','%s','%s','%s',NOW())";
    ...
    public Card selectBySno(String sno){
        String strSql="Select * from card where sno= ?";
        RowMapper<Card> rm =new BeanPropertyRowMapper<Card>(Card.class);
        return  this.jdbcTemplate.queryForObject(strSql,rm,sno);
    }

    public Card selectBySnoforMoney(String sno){
        String strSql="Select sno,money from card as blance where sno= ?";
        RowMapper<Card> rm =new BeanPropertyRowMapper<Card>(Card.class);
        return  this.jdbcTemplate.queryForObject(strSql,rm,sno);
    }
